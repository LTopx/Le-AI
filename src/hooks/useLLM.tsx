...
const useStore = create<LLMState & LLMAction>((set) => ({
  openai: {
    label: "OpenAI",
    value: "openai",
    ico: <Icon icon={openaiIcon} color="#71a697" size={16} />,
    ico_big: <Icon icon={openaiIcon} color="#71a697" size={32} />,
    models: [
  ...
  azure: {
    label: "Azure OpenAI",
    value: "azure",
    ico: <Icon icon={azureIcon} size={16} />,
    ico_big: <Icon icon={azureIcon} size={32} />,
    models: [
      // system default
