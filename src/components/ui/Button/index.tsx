  ...
  (
    ...
    return (
      <button
        ...
        onClick={onBtnClick}
        className={cn(
          "group border whitespace-nowrap transition-all duration-100 ease-linear rounded-md font-medium flex items-center justify-center gap-1.5 tracking-wide",
        ...
        {leftIcon ? (
          <>
            {loading ? (
              ...
              <span
                className={cn({
                  "group-hover:scale-[1.18] transition-transform": scaleable,
                })}
              >
                {leftIcon}
              </span>
